GeoCV=function(fit, K=100, n.fold=0.05, sparse=FALSE, which=1)
{
...
pr=GeoKrig(data=datanew, coordx=coordsnew, coordy=NULL, coordt=NULL, coordx_dyn=NULL,  #ok
	       corrmodel=fit$corrmodel, distance=fit$distance,grid=fit$grid,loc=loc_to_pred, #ok
	       maxdist=NULL, maxtime=NULL, method="cholesky", model=fit$model,fit$n, #ok
           nloc=NULL, mse=FALSE, lin_opt=TRUE,param=as.list(c(fit$param,fit$fixed)), 
           radius=fit$radius, sparse=sparse, taper=NULL, tapsep=NULL, time=NULL, 
           type="Standard",type_mse=NULL, type_krig="Simple", #ok
           weigthed=TRUE, which=which, X=X,Xloc=Xloc) #ok
...
#####################################
pr=GeoKrig(data=datanew, coordx=NULL, coordy=NULL, coordt=NULL, coordx_dyn=coordsnew,  #ok
	       corrmodel=fit$corrmodel, distance=fit$distance,grid=fit$grid,loc=loc_to_pred, #ok
	       maxdist=NULL, maxtime=NULL, method="cholesky", model=fit$model,fit$n, #ok
           nloc=NULL, mse=FALSE, lin_opt=TRUE,param=as.list(c(fit$param,fit$fixed)), 
           radius=fit$radius, sparse=sparse, taper=NULL, tapsep=NULL, time=NULL, 
